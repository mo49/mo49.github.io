<template>
  <section class="container work" data-page="work">
    <h1 class="work__title">{{ $t('WORK_ONEPIECE_TITLE') }}</h1>
    <div class="work-about" data-bg="odd">
      <h2>{{ $t('WORK_HEADLINE_ABOUT') }}</h2>
      <pre>{{ $t('WORK_ONEPIECE_DESC') }}</pre>
    </div>
    <div class="work-image" data-bg="even">
      ...
      <ul class="work-image__list">
        ...
        <li class="work-image__item size-full">
          ...
          <figcaption>{{ $t('WORK_ONEPIECE_CAP4') }}</figcaption>
        </li>
        <li class="work-image__item size-full">
          <div class="youtube">
          ...
          <figcaption>{{ $t('WORK_ONEPIECE_CAP5') }}</figcaption>
        </li>
        <li class="work-image__item size-full">
          <div class="youtube">
          ...
          <figcaption>{{ $t('WORK_ONEPIECE_CAP6') }}</figcaption>
        </li>
      </ul>
    </div>
    ...
    <div class="work-time" data-bg="even">
      ...
      <p>{{ $t('WORK_ONEPIECE_PRODUCTION_TIME') }}</p>
    </div>
